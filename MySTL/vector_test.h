#ifndef MYSTL_VECTOR_TEST_H
#define MYSTL_VECTOR_TEST_H
...
//	v9 = std::move(v3);
	...
	FUN_AFTER(v1, v1.assign(test, test + 5));
...
//	FUN_AFTER(v1, v1.emplace_back(6));
	...
	FUN_AFTER(v1, v1.insert(v1.begin(), test, test + 5));
	...
	*++p = 20;
	...
	CON_TEST_P1(vector<int>, push_back, rand(), XL(LEN1), XLL(LEN2), XLL(LEN3));
#else
	CON_TEST_P1(vector<int>, push_back, rand(), L(LEN1), XL(LEN2), XXL(LEN3));
#endif
	std::cout << "|---------------------|-------------|-------------|-------------|\n";
	PASSED;
#endif
